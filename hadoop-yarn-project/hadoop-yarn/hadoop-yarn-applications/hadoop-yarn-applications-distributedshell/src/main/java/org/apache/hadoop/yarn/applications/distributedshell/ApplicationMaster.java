...
import org.apache.hadoop.yarn.applications.distributedshell.Major.MajorClient;
...
//    int numtc = numTotalContainers;
//    try {
////      MajorClient.AMreport(appMasterHostname, appAttemptID.toString(), numtc, numCompletedContainers.get(), numAllocatedContainers.get(), numFailedContainers.get(), requestPriority);
...
//    }
  ...
  public void run() throws YarnException, IOException {
    ...
    LOG2.info("======MAJORSHI AM:run() numTotalContainers:" + numTotalContainers + " numTotalContainersToRequest:" + numTotalContainersToRequest);
  ...
  private class RMCallbackHandler implements AMRMClientAsync.CallbackHandler {
    ...
    public void onContainersAllocated(List<Container> allocatedContainers) {
      ...
      for (Container allocatedContainer : allocatedContainers) {
        ...
        LOG2.info("^^^^ContainersAllocated:" + allocatedContainer.getId().toString());
  ...
  private ContainerRequest setupContainerAskForRM() {
    ...
    LOG.info("======MAJORSHI ASKPriority:" + requestPriority);
